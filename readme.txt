...
Contributors: Hamed Fuladi
Tags: woocommerce, e-commerce, order, mihansignal, download, bulk, store, sales, sell, woo, shop, cart, checkout, downloadable, downloads, payments, paypal, storefront, stripe, woo commerce
...
This plugin, fix download problem that happens with new added files to products, you can regenerate download permissions for all orders of a product so that those with old orders could download the new file.
...
**[check out my other plugins here](https://mihansignal.com/)
== Screenshots ==
1. Steps
== How to use ==
